...
DESCRIPTION="P2P Internet currency based on X11. It's ASIC resistant, Highly distributed and Anonymous."
...
src_configure() {
	...
	#The darkcoin codebase is mostly taken from bitcoin-qt
...
src_install() {
	...
	make_desktop_entry "${PN} %u" "Darkcoin-Qt" "/usr/share/pixmaps/${PN}.ico" "Qt;Network;P2P;Office;Finance;" "MimeType=x-scheme-handler/darkcoin;\nTerminal=false"
